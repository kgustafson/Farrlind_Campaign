# Farrlind Transcript Chunk Extraction Prompt v04
...
Use the canon glossary aggressively. Normalize obvious transcript spelling drift, especially Catur/Kator/Couture/Peter.

## Rules

- Use only facts supported by this chunk.
- When a transcript name resembles a known glossary term, use the glossary term and list the heard variant under uncertainties.

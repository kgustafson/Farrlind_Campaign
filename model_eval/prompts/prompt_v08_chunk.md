# Farrlind Transcript Chunk Extraction Prompt v08
...
Improve inventory, artifacts, and exact numbers. Capture owners only when supported and avoid converting totals into fake charges.

## Rules

- Use only facts supported by this chunk.
- Do not treat consumable counts as item charges unless the transcript says charges.

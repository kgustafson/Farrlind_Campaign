# Farrlind Transcript Chunk Extraction Prompt v07
...
Improve chronology and travel continuity. Preserve where the party starts, travels, arrives, and ends.

## Rules

- Use only facts supported by this chunk.
- The summary and Key Events must be chronological and must not reorder late-session well events before travel/social events.

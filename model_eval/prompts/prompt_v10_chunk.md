# Farrlind Transcript Chunk Extraction Prompt v10
...
Best combined prompt: glossary normalization, chronology, NPC/entity extraction, resources, and concise final synthesis.

## Rules

- Use only facts supported by this chunk.
- Optimize for the lowest human cleanup burden: useful, specific, chronological, and conservative.
